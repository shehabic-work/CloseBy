...
public class CloseBy
{
	...
	public static class Item
	{
        ...
        public int getMarginTop()
        {
            return marginType == MARGIN_TYPE_ABSOLUTE
                    ? marginTop
                    : (int) Math.round(marginTopRelative * getRelativeView().getMeasuredHeight());
        }
        ...
        public int getMarginBottom()
        {
            return marginType == MARGIN_TYPE_ABSOLUTE
                    ? marginBottom
                    : (int) Math.round(marginBottomRelative * getRelativeView().getMeasuredHeight());
        }
        ...
        public int getMarginLeft()
        {
            return marginType == MARGIN_TYPE_ABSOLUTE
                    ? marginLeft
                    : (int) Math.round(marginLeftRelative * getRelativeView().getMeasuredWidth());
        }
        ...
        public int getMarginRight()
        {
            return marginType == MARGIN_TYPE_ABSOLUTE
                    ? marginRight
                    : (int) Math.round(marginRightRelative * getRelativeView().getMeasuredWidth());
        }
	...
	public static class Builder
	{
		...
		public CloseBy build()
		{
			...
			CloseBy closeBy =  new CloseBy(this.activity, this.srcView, this.clsBy, this.position, this.horizontalAlignment,
